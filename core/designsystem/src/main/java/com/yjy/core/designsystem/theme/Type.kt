...
internal val ChallengeTogetherTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = FontFamily(
            Font(R.font.impact, FontWeight.ExtraBold)
        ),
    ...
    displayMedium = TextStyle(
        fontFamily = FontFamily(
            Font(R.font.suseongdotum, FontWeight.Bold)
        ),
    ...
    headlineLarge = TextStyle(
        fontFamily = FontFamily(
            Font(R.font.kimjungchulgothic_bold, FontWeight.Bold)
        ),
        fontWeight = FontWeight.Bold,
        fontSize = 32.sp,
        lineHeight = 40.sp,
    ...
    bodyLarge = TextStyle(
        fontFamily = FontFamily(
            Font(R.font.kimjungchulgothic_regular, FontWeight.Medium)
        ),
