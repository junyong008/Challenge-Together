...
@Composable
internal fun CommentedRoute(
    onBackClick: () -> Unit,
    onPostClick: (postId: Int) -> Unit,
    modifier: Modifier = Modifier,
    viewModel: CommunityViewModel = hiltViewModel(),
) {
    val posts = viewModel.commentedPosts.collectAsLazyPagingItems()
    ...
    Scaffold(
        topBar = {
            ChallengeTogetherTopAppBar(
                ...
                titleRes = R.string.feature_community_commented_posts,
            )
        },
                ...
                isIdle && isEmpty -> {
                    EmptyBody(
                        ...
                        description = stringResource(
                            id = R.string.feature_community_no_commented_posts_description,
                        ),
                    )
                }
