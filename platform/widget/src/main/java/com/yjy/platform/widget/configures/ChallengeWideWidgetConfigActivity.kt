...
import com.yjy.platform.widget.widgets.ChallengeListWidget.Companion.THEME_TYPE_KEY
    ...
    fun ChallengeWideWidgetConfigContent(
        ...
        LaunchedEffect(challenges) {
            if (challenges.isEmpty() || selectedChallenge == null) {
                ...
                onThemeTypeChange(ThemeType.from(prefs[intPreferencesKey(THEME_TYPE_KEY)] ?: 0))
            }
        }
